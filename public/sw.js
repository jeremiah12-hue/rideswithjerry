    ...
    event.waitUntil(
      caches.open('my-cache').then((cache) => {
        return cache.addAll([
          ...
          './gallery/buy_img/buy1.avif',
          './gallery/buy_img/buy2.avif',
          './gallery/buy_img/buy3.avif',
          ...
          './gallery/save_img/save1.avif',
          './gallery/save_img/save2.avif',
          './gallery/save_img/save3.avif',
          './gallery/save_img/save4.avif',
          './gallery/sell_img/sell1.avif',
          './gallery/sell_img/sell2.avif',
          './gallery/favicon.ico',
